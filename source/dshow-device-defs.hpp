...
#define HD_PVR1_CX                COMMON_ENCODED_CX
#define HD_PVR1_CY                COMMON_ENCODED_CY
#define HD_PVR1_INTERVAL          COMMON_ENCODED_INTERVAL
#define HD_PVR1_VFORMAT           COMMON_ENCODED_VFORMAT
#define HD_PVR1_AFORMAT           AudioFormat::AC3
#define HD_PVR1_SAMPLERATE        COMMON_ENCODED_SAMPLERATE
...
#define HD_PVR_ROCKET_CX          COMMON_ENCODED_CX
#define HD_PVR_ROCKET_CY          COMMON_ENCODED_CY
#define HD_PVR_ROCKET_INTERVAL    COMMON_ENCODED_INTERVAL
#define HD_PVR_ROCKET_VFORMAT     COMMON_ENCODED_VFORMAT
#define HD_PVR_ROCKET_AFORMAT     AudioFormat::MPGA
#define HD_PVR_ROCKET_SAMPLERATE  COMMON_ENCODED_SAMPLERATE
